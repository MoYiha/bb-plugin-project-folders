...
Страница плагина и раздел плагина в настройках BB показывают одни и те же настройки на четырёх вкладках: **Список чатов** (сортировка, лимит, порог автосворачивания, жирный шрифт для непрочитанного, плотность, отступ), **Оформление**, **Правила AGENTS.md** и **Импорт и экспорт**.
