...
В меню **⋯ → Сортировка чатов** проекта или раздела можно выбрать сортировку по активности, по алфавиту или по дате создания. По умолчанию используется активность: новые обновления и события внимания BB поднимают чат внутри его проекта или раздела. Закреплённые чаты остаются сверху. Разделы, в чатах которых давно не было активности (по умолчанию 2 часа, порог настраивается), автоматически сворачиваются, чтобы не загромождать дерево (переключатель доступен в настройках и в меню раздела).

Лимит задаётся в **Настройках** на странице плагина. Сначала показываются **10 чатов**. Лимит можно изменить от 1 до 100; он применяется отдельно к каждому проекту, разделу и списку без проекта. **Показать все** разворачивает только выбранный список, **Свернуть список** возвращает лимит. Настройки хранятся на сервере BB и одинаковы на всех устройствах. Для отдельного раздела сортировку и лимит можно изменить в его «Оформлении».

## Единые настройки и оформление

Страница плагина и раздел плагина в настройках BB показывают одни и те же разделы настроек: **Список чатов** (сортировка, лимит, порог автосворачивания, жирный шрифт для непрочитанного, плотность, отступ), **Оформление**, **Правила AGENTS.md**, **Архив разделов** и **Импорт и экспорт**. На странице плагина они перечислены в блоке **Настройки** над деревом проектов, в настройках BB — в собственном боковом меню.

В **Оформлении** для проектов и разделов 1, 2 и 3+ уровня задаются иконка, цвет и заливка. Иконки выбираются из набора Hugeicons с поиском, можно поставить любой эмодзи. Цвет: 12 оттенков, которые читаются в светлой и тёмной теме, или свой. Заливка: без неё, подложка иконки, полоса слева или фон строки. Пресеты «Стандарт», «Монохром», «По уровням» и «По проектам» меняют всё оформление одним нажатием; в режиме «По проектам» разделы получают цвет своего проекта. Любой проект или раздел можно оформить отдельно через **⋯ → Оформление** и при желании распространить это на вложенные разделы. **Импорт и экспорт** сохраняет всю настройку в JSON-файл.
